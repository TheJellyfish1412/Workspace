...
correctBuild = Rayfield:FindFirstChild('Build') ~= nil and Rayfield.Build.Value == InterfaceBuild
...
local Icons = nil
local iconsTried = false
local function loadIcons()
	if not iconsTried then
		iconsTried = true
...
local function resolveIcon(icon)
	...
	if typeof(icon) == "string" and loadIcons() then
