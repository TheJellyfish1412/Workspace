...
function create:Win(text, logo)
    ...
    Ui_mobile_img.MouseButton1Click:Connect(pcall(function()
        if library.toggledui == false then
            library.toggledui = true
            TweenService:Create(
                MainFrame,
            ...
            function items:Drop(text, text2, use, option, callback, LogoDrop)
                ...
                if use == false then
                    ...
                    for i, v in pairs(list) do
                        ...
                        listtextbutton.MouseButton1Click:Connect(
                            function()
                                if not location[v.flag] then
                                    listimage:TweenSizeAndPosition(
                                        UDim2.new(0, 30, 0, 30),
                                        UDim2.new(0.5, 0, 0.5, 0),
                                        "In",
                                        "Bounce",
...
local GameWorld = require(game:GetService("ReplicatedStorage").Shared.Info.GameWorld.Levels)
local CraftingRecipes = require(game:GetService("ReplicatedStorage").Shared.Info.CraftingRecipes)
